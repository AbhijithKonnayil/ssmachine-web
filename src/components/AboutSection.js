            ...
            <div class="col-xl-5 col-md-12 col-lg-6">
              <div class="section-title">
                ...
                <p class="para-text">
                  ...
                  specialist in the UAE. Dedicated to meeting the specific
                  demands of European Luxury Cars, our team shares your passion
                  for performance, service and value. Seven Seas Automobiles
                  state of the art workshop in Al Quoz, Dubai, houses the
                  technical acumen and diagnostic equipment to deliver
                  unrivalled levels of professionalism and quality at
                  significantly lower costs than those of a main dealer.
                  Hundreds of discerning German car owners entrust us every year
                  to service, repair and optimize their driving machines. We at
                  Seven Seas Machinery are a customer friendly business that can
                  offer you a complete car repair service we primarily aim at
                  the prestige car market.
                </p>
                <NavLink to="/about" class="boxed-btn">
                  Learn More
                </NavLink>
              </div>
            </div>
