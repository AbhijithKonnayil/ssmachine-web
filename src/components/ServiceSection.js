          ...
          <div class="row align-items-center ">
            <div className="col-md-12">
              <div class="section-title text-center mb-65">
                ...
                <p class="para-text">
                  Seven Seas Automobiles offers a full range of auto repair
                  services for European cars (AUDI, BMW, Mercedes-Benz,
                  Volkswagen, Mini-Cooper, Bentley, Porsche, Land-Rover, Volvo,
                  Jaguar, Maserati and Lamborghini). We value our integrity,
                  credibility and will never compromise on quality.
                </p>
              </div>
            </div>
          </div>
